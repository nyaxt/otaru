...
var Assets = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2018, 6, 24, 7, 50, 25, 701652379, time.UTC),
		},
		...
		"/index.otaru-fe.html": &vfsgen۰CompressedFileInfo{
			name:             "index.otaru-fe.html",
			modTime:          time.Date(2018, 6, 24, 7, 50, 25, 701652379, time.UTC),
		...
		"/index.otaru-server.html": &vfsgen۰CompressedFileInfo{
			name:             "index.otaru-server.html",
			modTime:          time.Date(2018, 6, 16, 10, 24, 57, 371934456, time.UTC),
			uncompressedSize: 6636,
	...
	fs["/"].(*vfsgen۰DirInfo).entries = []os.FileInfo{
		...
		fs["/index.otaru-fe.html"].(os.FileInfo),
		fs["/index.otaru-server.html"].(os.FileInfo),
